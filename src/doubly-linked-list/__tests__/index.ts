...
// TODO: check specific test cases for doubly linked list
...
describe("DoublyLinkedList", () => {
  ...
  describe("Initial State", () => {
    ...
    test("next and prev values of nodes should be null", () => {
  ...
  describe("Push Method", () => {
    test("it should add value to end of DoublyLinkedList", () => {
      expect(list.tail?.value).toBe(1);
      list.push(2);
    ...
    test("it should add value to head when DoublyLinkedList is empty", () => {
      list.pop();
    ...
    test("it should return this instance of DoublyLinkedList", () => {
  ...
  describe("Pop Method", () => {
    ...
    test("it should set new tail to have null as next and move the prev pointer", () => {
      list.push(2);
      list.push(3);
      list.pop();
  ...
  describe("Unshift Method", () => {
    test("it should insert an element at the beginning of the DoublyLinkedList", () => {
      list.unshift(2);
      expect(list.head?.value).toBe(2);
      expect(list.tail?.value).toBe(1);
    });
    ...
    test("it should point the head and the tail to the added element when the DoublyLinkedList is empty", () => {
      list.pop();
      list.unshift(2);
      expect(list.head?.value).toBe(2);
      expect(list.tail?.value).toBe(2);
